...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--prompts_path",
        default="/scratch/yang.xiaome/code/SDPruning_moe/SDPruning/scripts/benchmark-prompts.json",
        type=str,
        help="Path to the prompts json list file, each item of which is a dict with keys `id` and `prompt`.",
    )
    parser.add_argument(
        "--result_dir",
        default="/projects/yanzhi_group/yang.xiaome/dataset/T2I/ImageReward/results/",
        type=str,
        help="Path to the metric results directory",
    )
    parser.add_argument(
        "--img_dir",
        default="/projects/yanzhi_group/yang.xiaome/dataset/T2I/ImageReward",
        type=str,
